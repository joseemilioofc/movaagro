...
import { Truck, UserCircle, ArrowLeft, Leaf, Database, Calculator, Code, Eye, Target, Handshake, Shield, Zap, Calendar, Lightbulb, Rocket, Users, Award } from "lucide-react";
...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Timeline Section */}
      <section className="container mx-auto px-3 sm:px-4 py-12 sm:py-20 bg-gradient-to-b from-muted/30 to-background">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A história da MOVA e os marcos que moldaram nossa trajetória
            </p>
          </div>
          ...
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-4 sm:left-1/2 sm:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/50 to-primary/20"></div>

            {/* Timeline items */}
            <div className="space-y-8 sm:space-y-12">
              {/* 2023 - Ideia */}
              <div className="relative flex items-start gap-4 sm:gap-8">
                <div className="hidden sm:block sm:w-1/2 sm:text-right sm:pr-8">
                  <div className="inline-block bg-card rounded-xl p-4 sm:p-6 shadow-lg border border-border">
                    <span className="text-primary font-bold text-lg">2023</span>
                    <h3 className="text-lg font-bold text-foreground mt-1">A Ideia Nasce</h3>
                    <p className="text-muted-foreground text-sm mt-2">
                      José Emílio identifica a necessidade crítica de conectar agricultores a transportadoras de forma eficiente em Moçambique.
                    </p>
                  </div>
                </div>
                <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 w-10 h-10 bg-primary rounded-full flex items-center justify-center shadow-lg z-10">
                  <Lightbulb className="w-5 h-5 text-primary-foreground" />
                </div>
                <div className="sm:hidden ml-12 bg-card rounded-xl p-4 shadow-lg border border-border flex-1">
                  <span className="text-primary font-bold text-lg">2023</span>
                  <h3 className="text-lg font-bold text-foreground mt-1">A Ideia Nasce</h3>
                  <p className="text-muted-foreground text-sm mt-2">
                    José Emílio identifica a necessidade crítica de conectar agricultores a transportadoras de forma eficiente em Moçambique.
              ...
              <div className="relative flex items-start gap-4 sm:gap-8">
                ...
                <div className="sm:hidden ml-12 bg-card rounded-xl p-4 shadow-lg border border-border flex-1">
                  ...
                  <h3 className="text-lg font-bold text-foreground mt-1">Formação da Equipa</h3>
                  <p className="text-muted-foreground text-sm mt-2">
                    Junior Pedro e Aldo Mundulai juntam-se ao projecto, trazendo expertise em gestão de dados e conhecimento agrícola.
                  </p>
                </div>
              ...
              {/* 2024 Q2 - Desenvolvimento */}
              <div className="relative flex items-start gap-4 sm:gap-8">
                <div className="hidden sm:block sm:w-1/2 sm:text-right sm:pr-8">
                  <div className="inline-block bg-card rounded-xl p-4 sm:p-6 shadow-lg border border-border">
                    <span className="text-primary font-bold text-lg">2024</span>
                    <h3 className="text-lg font-bold text-foreground mt-1">Desenvolvimento da Plataforma</h3>
                    <p className="text-muted-foreground text-sm mt-2">
                      Início do desenvolvimento da plataforma MOVA com foco em simplicidade e acessibilidade para todos os utilizadores.
                    </p>
                  </div>
                </div>
                <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 w-10 h-10 bg-primary rounded-full flex items-center justify-center shadow-lg z-10">
              ...
              <div className="relative flex items-start gap-4 sm:gap-8">
                <div className="hidden sm:block sm:w-1/2"></div>
                <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 w-10 h-10 bg-gradient-primary rounded-full flex items-center justify-center shadow-lg ring-4 ring-primary/20 z-10">
                  <Rocket className="w-5 h-5 text-primary-foreground" />
                </div>
                <div className="sm:hidden ml-12 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-4 shadow-lg border border-primary/30 flex-1">
                  <span className="text-primary font-bold text-lg">2025</span>
                  <h3 className="text-lg font-bold text-foreground mt-1">Lançamento Oficial</h3>
                  <p className="text-muted-foreground text-sm mt-2">
                    A MOVA é lançada oficialmente, conectando cooperativas e transportadoras em todo Moçambique.
                  </p>
                </div>
                <div className="hidden sm:block sm:w-1/2 sm:pl-8">
                  <div className="inline-block bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-4 sm:p-6 shadow-lg border border-primary/30">
                    <span className="text-primary font-bold text-lg">2025</span>
                    <h3 className="text-lg font-bold text-foreground mt-1">Lançamento Oficial</h3>
                    <p className="text-muted-foreground text-sm mt-2">
                      A MOVA é lançada oficialmente, conectando cooperativas e transportadoras em todo Moçambique.
              ...
              <div className="relative flex items-start gap-4 sm:gap-8">
                <div className="hidden sm:block sm:w-1/2 sm:text-right sm:pr-8">
                  <div className="inline-block bg-card rounded-xl p-4 sm:p-6 shadow-lg border border-dashed border-primary/40">
                    <span className="text-primary font-bold text-lg">Futuro</span>
                    <h3 className="text-lg font-bold text-foreground mt-1">Expansão Regional</h3>
                    <p className="text-muted-foreground text-sm mt-2">
                      Planos de expansão para outras regiões e países da África Austral, impactando mais comunidades agrícolas.
                    </p>
                  </div>
                </div>
                <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 w-10 h-10 bg-muted border-2 border-dashed border-primary/50 rounded-full flex items-center justify-center shadow-lg z-10">
                  <Award className="w-5 h-5 text-primary" />
                </div>
                <div className="sm:hidden ml-12 bg-card rounded-xl p-4 shadow-lg border border-dashed border-primary/40 flex-1">
                  <span className="text-primary font-bold text-lg">Futuro</span>
                  <h3 className="text-lg font-bold text-foreground mt-1">Expansão Regional</h3>
                  <p className="text-muted-foreground text-sm mt-2">
                    Planos de expansão para outras regiões e países da África Austral, impactando mais comunidades agrícolas.
