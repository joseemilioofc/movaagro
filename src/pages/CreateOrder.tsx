    ...
    try {
      ...
      const { data: order, error: orderError } = await supabase
        ...
        .insert({
          ...
          mova_commission_rate: COMMISSION_SALES_PERCENT,
          mova_commission_amount: salesCommission,
          mova_transport_commission_rate: COMMISSION_FREIGHT_PERCENT,
          mova_transport_commission_amount: freightCommission,
